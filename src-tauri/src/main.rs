...
// Gộp các import của tauri lại cho gọn và không bị trùng
use std::collections::HashMap;
use std::io::{Read, Write};
use std::path::PathBuf;
use std::process::{ChildStdin, Command, Stdio};
use std::str::FromStr; // Dùng cho phím tắt
use std::sync::Mutex;
use std::thread;
...
fn main() {
    tauri::Builder::default()
        ...
        // 👇 2. THÊM BỘ CHẶN SỰ KIỆN "TẮT APP" VÀO ĐÂY 👇
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            send_input,
            quit_app, // <--- NHỚ KHAI BÁO HÀM MỚI VÀO ĐÂY
